--!nocheck
-- ============================================================
-- m1n3l1s HUB x CRIM KALETH | GUI m1n3l1s SIN KEY + funciones CRIM
-- Generado: combinacion automatica | GUI = m1n3l1s (sin key) | Funciones = crim kaleth
-- Uso: pega DIRECTO en tu executor (Delta/Potassium/Solara/Wave)
-- Tecla GUI: F1 (original crim) | Sin key, entra directo
-- ============================================================
...
-- GUI lista (sin key system)
m1n3l1sLib:Notify("m1n3l1s HUB", "Cargando CRIM x KALETH...", 3)
